...
public class MenuLogin extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btnMasuuk = (Button) findViewById(R.id.btnMasuk);
		btnDaftarr = (Button) findViewById(R.id.btnDaftar);
	...
	public void signIn(View V) {
		...
		final EditText ubahNamaPengguna = (EditText) dialog
				.findViewById(R.id.editTextUserNameToLogin);
		final EditText ubahKataSandi = (EditText) dialog
