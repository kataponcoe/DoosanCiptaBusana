...
import kataponcoe.flip.horizontal.SejarahDoosanAdapter;
import id.kataponcoe.doosanciptabusana.R;

public class FlipSejarahDoosan extends Activity {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    setTitle("Sejarah Doosan Cipta");

    flipView = new FlipViewController(this, FlipViewController.HORIZONTAL);

    flipView.setAdapter(new SejarahDoosanAdapter(this));
